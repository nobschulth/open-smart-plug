...
> **Warning:** It was developed for the chip `cb2s` ([CB2S](https://docs.libretiny.eu/boards/cb2s/)) and the model Soundlogic Smart Plug and might not work on other smart plugs.
...
```
On windows, you need to replace `/dev/ttyACM0`.
